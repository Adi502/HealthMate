...
class BlinkAlertsScreen extends StatefulWidget {
  final VoidCallback toggleMenu;

  const BlinkAlertsScreen({super.key, required this.toggleMenu});

  @override
  _BlinkAlertsScreenState createState() => _BlinkAlertsScreenState();
}

class _BlinkAlertsScreenState extends State<BlinkAlertsScreen> {
  bool _isMenuOpen = false;
  int _selectedMins = 20; // Default value for mins
  ...
  Future<void> _sendNotification() async {
    int delayInSeconds = _selectedMins * 60;
    ...
    _notificationTimer = Timer.periodic(Duration(seconds: delayInSeconds), (Timer timer) async {
      ...
      await flutterLocalNotificationsPlugin.show(
        0, // Notification ID
        'Blink Reminder', // Notification title
        'Make Sure to blink your eyes', // Notification body
  ...
  void _handleSubmit() async {
    CoolAlert.show(
      ...
      text: 'You will be notified to drink water after every $_selectedMins mins'
    );
      _sendNotification();
  }
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text(
                        "Please select how often you'd like to receive blink reminders.",
